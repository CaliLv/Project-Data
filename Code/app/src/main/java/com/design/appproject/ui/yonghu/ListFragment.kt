...
class ListFragment : BaseBindingFragment<YonghucommonListLayoutBinding>() {
    ...
    val queryIndex = Pair<String,String>("User Account","yonghuzhanghao")/*查询索引*/

    override fun initEvent() {
        setBarTitle("User",mHasBack)
        setBarColor("#FFFFFF","black")
        binding.apply {
            addBtn.isVisible = (mIsBack && Utils.isAuthBack("yonghu","Add"))|| Utils.isAuthFront("yonghu","新增")
