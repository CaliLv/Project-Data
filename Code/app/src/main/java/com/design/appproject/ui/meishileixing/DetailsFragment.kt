...
import com.design.appproject.logic.viewmodel.meishileixing.DetailsViewModel
import androidx.activity.viewModels
import com.youth.banner.adapter.BannerImageAdapter
import com.youth.banner.holder.BannerImageHolder
import com.alibaba.android.arouter.facade.annotation.Autowired
import com.alibaba.android.arouter.facade.annotation.Route
import com.design.appproject.databinding.MeishileixingcommonDetailsLayoutBinding
 ...
 * 美食类型详情页
 */
@Route(path = CommonArouteApi.PATH_FRAGMENT_DETAILS_MEISHILEIXING)
class DetailsFragment : BaseBindingFragment<MeishileixingcommonDetailsLayoutBinding>() {
    ...
    private var mMeishileixingItemBean=MeishileixingItemBean()/*详情内容*/


    @SuppressLint("SuspiciousIndentation")
    override fun initEvent() {
        setBarTitle("Food Type Details Page")
    ...
    override fun initData() {
        ...
        mDetailsViewModel.infoLiveData.observeKt(errorBlock = {binding.srv.isRefreshing =false}) {
            it.getOrNull()?.let { info->
                ...
                mMeishileixingItemBean = info.data
                 binding.setInfo()
            }
        }
    ...
    private fun loadData(){
        mDetailsViewModel.info("meishileixing",mId.toString())
    }


    private fun MeishileixingcommonDetailsLayoutBinding.setInfo(){
        meishileixingTv.text = "${mMeishileixingItemBean.meishileixing}"
    }
