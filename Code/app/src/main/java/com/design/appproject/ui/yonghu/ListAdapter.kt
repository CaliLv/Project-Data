...
class ListAdapter : LoadMoreAdapter<YonghuItemBean>(R.layout.yonghu_list_item_layout) {
    ...
    override fun convert(holder: BaseViewHolder, item: YonghuItemBean) {
        ...
        mIsBack.yes {
            holder.setGone(R.id.edit_fl,!Utils.isAuthBack("yonghu","Modify"))
            holder.setGone(R.id.delete_fl,!Utils.isAuthBack("yonghu","Delete"))
        }.otherwise {
            holder.setGone(R.id.edit_fl,!Utils.isAuthFront("yonghu","Modify"))
            holder.setGone(R.id.delete_fl,!Utils.isAuthFront("yonghu","Delete"))
        }
    }
}