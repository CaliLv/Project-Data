...
import com.design.appproject.logic.viewmodel.gouwuqingdan.DetailsViewModel
import androidx.activity.viewModels
import com.youth.banner.adapter.BannerImageAdapter
import com.youth.banner.holder.BannerImageHolder
import com.alibaba.android.arouter.facade.annotation.Autowired
import com.alibaba.android.arouter.facade.annotation.Route
import com.design.appproject.databinding.GouwuqingdancommonDetailsLayoutBinding
 ...
 * 购物清单详情页
 */
@Route(path = CommonArouteApi.PATH_FRAGMENT_DETAILS_GOUWUQINGDAN)
class DetailsFragment : BaseBindingFragment<GouwuqingdancommonDetailsLayoutBinding>() {
    ...
    private var mGouwuqingdanItemBean=GouwuqingdanItemBean()/*详情内容*/


    @SuppressLint("SuspiciousIndentation")
    override fun initEvent() {
        setBarTitle("Shopping List Details Page")
    ...
    override fun initData() {
        ...
        mDetailsViewModel.infoLiveData.observeKt(errorBlock = {binding.srv.isRefreshing =false}) {
            it.getOrNull()?.let { info->
                ...
                mGouwuqingdanItemBean = info.data
                 binding.setInfo()
            }
        }
    ...
    private fun loadData(){
        mDetailsViewModel.info("gouwuqingdan",mId.toString())
    }


    private fun GouwuqingdancommonDetailsLayoutBinding.setInfo(){
        jihuamingchengTv.text = "${mGouwuqingdanItemBean.jihuamingcheng}"
        jihualeixingTv.text = "${mGouwuqingdanItemBean.jihualeixing}"
        goumairiqiTv.text = "${mGouwuqingdanItemBean.goumairiqi}"
        qingdanxiangqingCw.setHtml(mGouwuqingdanItemBean.qingdanxiangqing.trim())
        yonghuzhanghaoTv.text = "${mGouwuqingdanItemBean.yonghuzhanghao}"
        yonghuxingmingTv.text = "${mGouwuqingdanItemBean.yonghuxingming}"
    }
